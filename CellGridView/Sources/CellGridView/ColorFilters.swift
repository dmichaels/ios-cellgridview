public struct ColorFilters
{
    ...
    private static let R: UInt32 = CellColor.RED
    private static let G: UInt32 = CellColor.GREEN
    private static let B: UInt32 = CellColor.BLUE
}
